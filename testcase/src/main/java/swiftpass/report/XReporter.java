...
public class XReporter implements IReporter{
	...
	private void startHtml(){
		...
		writer.println("<br/><h4 style=\"text-align:left;\">时间： " + reportDate + "</h4><br/>");	
		writer.println("<br/><h4 style=\"text-align:right;\">总耗时： " + SwiftPass.convertTime(RunCaseProcessor.time()) + "</h4><br/>");
	}
