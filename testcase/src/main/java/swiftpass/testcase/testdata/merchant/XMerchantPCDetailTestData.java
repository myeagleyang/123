...
public class XMerchantPCDetailTestData {
	...
	public static MerchantPCDetailCaseBean[][] data(){
		...
		noselectMerchant.setIsClickFirstRowMerchant("false");
		...
		noselectPTt.setIsClickFirstRowMerchant("false");
		noselectPTt.setIsClickFirstRowPT("false");
